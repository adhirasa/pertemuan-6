...
public class variabel {
    public static void main(String[] args) {
        ...
        if (variabel1 < variabel2) {
            System.out.println("Variabel1 = "+ variabel1 + "kurang dari"
                    + "batasBawah yang bernilai "+ batasBawah );
}
        ...
        if (variabel1 <= batasBawah || variabel1 >= batasAtas) {
            System.out.println("Variabel 1 nilainya tidak berada di antara"
                    + "variabel 2 dan variabel 3");
}
        if (variabel1 > batasBawah && variabel1 < batasAtas) {
